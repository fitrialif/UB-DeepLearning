...
while (ecount<16):
	...
	for train_pullbacks, test_pullbacks in kf.split(indices_pullbacks):
		...
		if(ecount==0):
			...
			net.compile_model(input_shape=(128,128),n_target_feat=1,nfilters=32,dropout=0.4)
			...
			net_name = '3-BN-32-04'+ 'SingleNet_Calcio_30CLEAN_UNION_FOLD%d'%current_fold
		elif(ecount==1):
		    	net = MauNet_Calcio_3L_BN()
			smetrics = SingleLabelMonitor()
			net.compile_model(input_shape=(128,128),n_target_feat=1,nfilters=16,dropout=0.4)
			...
			print(model_name)
			net_name = '3-BN-16-04'+ 'SingleNet_Calcio_30CLEAN_UNION_FOLD%d'%current_fold
		elif(ecount==2):
		    	net = MauNet_Calcio_3L_BN()
			smetrics = SingleLabelMonitor()
			net.compile_model(input_shape=(128,128),n_target_feat=1,nfilters=32,dropout=0.1)
			...
			print(model_name)
			net_name = '3-BN-32-01'+ 'SingleNet_Calcio_30CLEAN_UNION_FOLD%d'%current_fold

		elif(ecount==3):
		    	net = MauNet_Calcio_3L_BN()
			smetrics = SingleLabelMonitor()
			net.compile_model(input_shape=(128,128),n_target_feat=1,nfilters=16,dropout=0.1)
			...
			print(model_name)
			net_name = '3-BN-16-01'+ 'SingleNet_Calcio_30CLEAN_UNION_FOLD%d'%current_fold
		elif(ecount==4):
			...
			print(model_name)
			net_name = '3-32-04'+ 'SingleNet_Calcio_30CLEAN_UNION_FOLD%d'%current_fold
		elif(ecount==5):
		    	net = MauNet_Calcio_3L()
			smetrics = SingleLabelMonitor()
			net.compile_model(input_shape=(128,128),n_target_feat=1,nfilters=16,dropout=0.4)
			...
			print(model_name)
			net_name = '3-16-04'+ 'SingleNet_Calcio_30CLEAN_UNION_FOLD%d'%current_fold
		elif(ecount==6):
		    	net = MauNet_Calcio_3L()
			smetrics = SingleLabelMonitor()
			net.compile_model(input_shape=(128,128),n_target_feat=1,nfilters=32,dropout=0.1)
			...
			print(model_name)
			net_name = '3-32-01'+ 'SingleNet_Calcio_30CLEAN_UNION_FOLD%d'%current_fold
		elif(ecount==7):
		    	net = MauNet_Calcio_3L()
			smetrics = SingleLabelMonitor()
			net.compile_model(input_shape=(128,128),n_target_feat=1,nfilters=16,dropout=0.1)
			...
			print(model_name)
			net_name = '3-16-01'+ 'SingleNet_Calcio_30CLEAN_UNION_FOLD%d'%current_fold
		elif(ecount==8):
			...
			print(model_name)
			net_name = '4-BN-32-04'+ 'SingleNet_Calcio_30CLEAN_UNION_FOLD%d'%current_fold
		elif(ecount==9):
		    	net = MauNet_Calcio_4L_BN()
			smetrics = SingleLabelMonitor()
			net.compile_model(input_shape=(128,128),n_target_feat=1,nfilters=16,dropout=0.4)
			...
			print(model_name)
			net_name = '4-BN-16-04'+ 'SingleNet_Calcio_30CLEAN_UNION_FOLD%d'%current_fold
		elif(ecount==10):
		    	net = MauNet_Calcio_4L_BN()
			smetrics = SingleLabelMonitor()
			net.compile_model(input_shape=(128,128),n_target_feat=1,nfilters=32,dropout=0.1)
			...
			print(model_name)
			net_name = '4-BN-32-01'+ 'SingleNet_Calcio_30CLEAN_UNION_FOLD%d'%current_fold
		elif(ecount==11):
		    	net = MauNet_Calcio_4L_BN()
			smetrics = SingleLabelMonitor()
			net.compile_model(input_shape=(128,128),n_target_feat=1,nfilters=16,dropout=0.1)
			...
			print(model_name)
			net_name = '4-BN-16-01'+ 'SingleNet_Calcio_30CLEAN_UNION_FOLD%d'%current_fold
		elif(ecount==12):
			...
			print(model_name)
			net_name = '4-32-04'+ 'SingleNet_Calcio_30CLEAN_UNION_FOLD%d'%current_fold
		elif(ecount==13):
		    	net = MauNet_Calcio_4L()
			smetrics = SingleLabelMonitor()
			net.compile_model(input_shape=(128,128),n_target_feat=1,nfilters=16,dropout=0.4)
			...
			print(model_name)
			net_name = '4-16-04'+ 'SingleNet_Calcio_30CLEAN_UNION_FOLD%d'%current_fold
		elif(ecount==14):
		    	net = MauNet_Calcio_4L()
			smetrics = SingleLabelMonitor()
			net.compile_model(input_shape=(128,128),n_target_feat=1,nfilters=32,dropout=0.1)
			...
			print(model_name)
			net_name = '4-32-01'+ 'SingleNet_Calcio_30CLEAN_UNION_FOLD%d'%current_fold
		elif(ecount==15):
		    	net = MauNet_Calcio_4L()
			smetrics = SingleLabelMonitor()
			net.compile_model(input_shape=(128,128),n_target_feat=1,nfilters=16,dropout=0.1)
			...
			print(model_name)
			net_name = '4-16-01'+ 'SingleNet_Calcio_30CLEAN_UNION_FOLD%d'%current_fold
